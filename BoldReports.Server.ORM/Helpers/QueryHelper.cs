    ...
    public static class QueryHelper
    {
        ...
        public static object GetData(object value)
        {
            ...
            else
            {
                ...
                data = (value == null || string.IsNullOrWhiteSpace(encodedValue.ToString())) ? "N'" + encodedValue + "'" : "N'" + encodedValue.ToString().Replace("'", "''") + "'";
            }
        ...
        public static string SafeDBString(string value)
        {
